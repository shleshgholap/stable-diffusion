...
Transforms images based on text prompts.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Image-to-image generation")
    parser.add_argument(
        "--checkpoint",
        type=str,
        required=True,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Text prompt for transformation",
    )
    parser.add_argument(
        "--negative-prompt",
        type=str,
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="outputs/img2img/output.png",
        help="Output path",
    )
    parser.add_argument(
        "--strength",
        type=float,
        default=0.75,
        help="Transformation strength (0-1)",
    )
    parser.add_argument(
        "--steps",
        type=int,
...
def main():
    ...
    pipeline = Image2ImagePipeline.from_pretrained(
        args.checkpoint,
